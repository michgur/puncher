...
htmx.defineExtension("path-params",{onEvent:function(e,a){if(e==="htmx:configRequest"){a.detail.path=a.detail.path.replace(/{([^}]+)}/g,function(e,t){var n=a.detail.parameters[t];delete a.detail.parameters[t];return n===undefined?"{"+t+"}":encodeURIComponent(n)})}}});
htmx.defineExtension("json-enc",{onEvent:function(e,n){if(e==="htmx:configRequest"){n.detail.headers["Content-Type"]="application/json"}},encodeParameters:function(e,n,t){e.overrideMimeType("text/json");return JSON.stringify(n)}});